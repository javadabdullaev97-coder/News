...
const concepts = [
  ...
  {
    id: "4a",
    name: "Концепт 4a — Шеврон с наклоном",
    desc: "Двойной шеврон, повёрнутый под углом 28° вверх — буквально показывает направление прыжка (вперёд и вверх). Связь с «leap» становится явной, при этом сохраняется лаконичность исходного концепта.",
