...
export const articles: Article[] = [
  {
    slug: "nuclear-plant-construction-start",
    title: "Узбекистан начал строительство АЭС за $9,5 млрд",
    lead: "В Джизакской области залит первый бетон энергоблока. По расчётам правительства, станция мощностью более 2 ГВт должна покрыть до 14% потребности страны и удешевить электроэнергию.",
    body: [
      "Старт строительства интегрированной атомной электростанции прошёл с участием президента Шавката Мирзиёева и российского коллеги Владимира Путина в формате телемоста. Контракт включает шесть энергоблоков общей мощностью свыше 2,1 ГВт, оценочная стоимость — $9,5 млрд.",
      "По заявлениям правительства, обещанная себестоимость электроэнергии с АЭС составит менее 1000 сумов за кВт·ч. Для сравнения, текущий розничный тариф для населения в среднем выше — что должно частично решить проблему вечерних отключений, остро стоящую в большинстве регионов.",
      "85-90% стоимости проекта покрывается российским государственным кредитом сроком на десятилетия. Это даёт Узбекистану доступ к передовым технологиям, но одновременно усиливает зависимость от внешнего финансирования — критики проекта обращают внимание на риски при возможном пересмотре условий.",
      "Полный ввод первого энергоблока ожидается через 5-7 лет. До этого времени дефицит электроэнергии в стране планируется покрывать за счёт расширения солнечной генерации и поставок из соседних стран.",
      "По данным Spot.uz и Gazeta.uz.",
    ],
    rubric: "economy",
    ...
    featured: true,
    tags: ["АЭС", "энергетика", "Джизак", "Россия"],
  },
  {
    slug: "mobiuz-sold-american-consortium",
    title: "Mobiuz продан американскому консорциуму за $351 млн",
    lead: "100% государственной доли второго мобильного оператора Узбекистана перешли консорциуму во главе с McKim and Company. Новые владельцы обещают инвестировать до $500 млн в инфраструктуру связи.",
    body: [
      "Государственная доля в Mobiuz, втором по числу абонентов мобильном операторе Узбекистана, продана американскому консорциуму за $351 млн. Покупатель — McKim and Company совместно с инвестфондом JVR. Сделка оформляет очередной этап приватизации в телекоммуникационном секторе.",
      "По условиям договора, новые владельцы должны инвестировать в инфраструктуру связи до $500 млн в ближайшие годы. Заявленные цели — модернизация сети 4G, расширение покрытия 5G и улучшение качества обслуживания. В компании работает около 8 миллионов абонентов.",
      "Параллельно у профессионалов индустрии возникают вопросы к прозрачности покупателя. McKim and Company практически не имеет публичной истории в открытых источниках, а JVR также остаётся малоизвестной. На непрозрачность сделки обратили внимание и в редакции Gazeta.uz в первые дни после объявления.",
      "Для абонентов главные вопросы — изменятся ли тарифы и не пострадает ли покрытие в регионах. Контракт обязательств по сохранению текущих условий обслуживания формально не содержит, что оставляет пространство для коммерческих решений нового владельца в ближайшие месяцы.",
      "По данным Spot.uz, Gazeta.uz и Podrobno.uz.",
    ],
    rubric: "business",
    ...
    featured: true,
    tags: ["Mobiuz", "приватизация", "связь", "США"],
  },
  {
    slug: "uzbekistan-world-cup-squad",
    title: "Каннаваро объявил состав сборной Узбекистана на ЧМ-2026",
    lead: "В заявку из 26 игроков вошёл защитник «Манчестер Сити» Абдукодир Хусанов. Турнир пройдёт с 11 июня по 19 июля в США, Канаде и Мексике.",
    body: [
      ...
      "Расписание матчей группового этапа по ташкентскому времени: с Колумбией 12 июня в 22:00, с Португалией 18 июня в 02:00 ночи, с ДР Конго 24 июня в 22:00. Прямые трансляции анонсированы на государственных каналах и Sevimli.",
      ...
      "По данным Tribuna.uz и Sportmail.ru.",
    ],
    rubric: "sport",
  ...
  {
    slug: "inflation-may-record-low",
    title: "Инфляция в Узбекистане упала до 5,5% — минимум с 2017 года",
    lead: "По итогам мая годовая инфляция замедлилась сразу на 1,5 процентных пункта к апрельскому уровню. ЦБ может пересмотреть базовую ставку 17 июня.",
    body: [
      "Годовая инфляция в Узбекистане в мае 2026 года замедлилась до 5,5% — это минимальное значение с 2017 года. По сравнению с апрелем показатель снизился на 1,5 процентных пункта, что стало неожиданностью для большинства аналитиков.",
      "Резкое снижение во многом объясняется так называемым «эффектом высокой базы»: в мае 2025 года в стране произошло разовое повышение тарифов на коммунальные услуги, которое подняло инфляцию выше 7%. Год спустя этот скачок выпал из расчёта, что и дало математическое замедление.",
      "Тем не менее, ключевая ставка ЦБ остаётся высокой — 14% годовых. Заседание правления Центрального банка пройдёт 17 июня, и рынок ждёт смягчения политики: первого за восемь месяцев. Снижение ставки означало бы постепенное удешевление кредитов для населения и бизнеса.",
      "В магазинах потребитель пока не чувствует серьёзного облегчения: цены на молочные продукты, овощи и фрукты остаются на пиковых для года уровнях. Реальное влияние замедления инфляции дойдёт до повседневных трат с задержкой 2-3 месяца.",
      "По данным Spot.uz.",
    ],
    rubric: "economy",
    authorSlug: "redakciya",
    ...
    readingTime: 3,
    cover: "https://images.unsplash.com/photo-1633158829585-23ba8f7c8caf?w=1600",
    tags: ["инфляция", "ЦБ", "ставка", "макро"],
  },
  {
    slug: "mirziyoyev-russia-energy-deal",
    title: "Узбекистан и Россия согласовали поставки бензина и сняли запреты на овощи",
    lead: "На полях Петербургского форума вице-премьер встретился с руководством «Газпрома», «Роснефти» и «Газпром нефти». Параллельно урегулирован спор Россельхознадзора с узбекскими экспортёрами.",
    body: [
  ...
  {
    slug: "ai-credit-scoring-launch",
    title: "Государство начнёт оценивать заёмщиков по 71 параметру с помощью ИИ",
    lead: "С 1 июля микрокредиты для бизнеса будут оформляться за час через цифровую платформу. С 1 декабря решение начнёт принимать алгоритм машинного обучения.",
    body: [
      "Министерство экономики и финансов утвердило запуск цифровой платформы микрокредитования для малого и среднего бизнеса. С 1 июля 2026 года предприниматели смогут оформить заём за один час полностью онлайн — без визита в банк и сбора бумажных документов.",
      "С 1 декабря решение по заявкам начнёт принимать ИИ-скоринг, основанный на анализе 71 набора данных из системы «Электронное правительство». Алгоритм будет учитывать налоговую дисциплину, обороты по счетам, историю взаимодействия с госорганами и десятки других факторов.",
      "Параллельно с запуском платформы беззалоговый лимит микрокредитов вырастает со 100 до 200 миллионов сумов. Это означает, что малый бизнес сможет получать более существенные суммы без обязательного предоставления имущества в залог.",
      "Главный вопрос, который пока остаётся открытым — приватность данных и право предпринимателя оспорить отказ алгоритма. Закон о цифровых правах, рассматриваемый сейчас в парламенте, мог бы дать механизм апелляции к ИИ-решениям. Но он не принят, а платформа уже запускается.",
      "По данным Spot.uz.",
    ],
    rubric: "tech",
    ...
    tags: ["ИИ", "кредиты", "скоринг", "бизнес"],
  },
  {
