...
TOPIC_KEYWORDS = {
    ...
    "society": [
        ...
        "консульск", "соотечественник", "популяц", "экосистем", "заповедник",
        "краснокнижн", "льготн проезд",
    ],
    "city": [
    ...
    "incidents": [
        ...
        "контрабанд", "протаранил", "задержан", "досудебн проверк", "потерпевш",
    ],
    "tech": [
    ...
    "culture": [
        ...
        "турнир", "игры будущего", "фиджитал", "фигитал", "олимп", "гол ", "сборная",
    ],
}
