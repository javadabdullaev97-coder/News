...
const concepts = [
  ...
  {
    id: 5,
    name: "Концепт 5 — Live-точка",
    desc: "Пульсирующая точка перед wordmark — ощущение прямого эфира, постоянного потока новостей. На бейдже — L с маленьким «индикатором». Динамично и современно.",
    Icon: IconLive,
    Logo: LogoLive,
  },
  {
    id: 6,
    name: "Концепт 6 — Подчёркивание-стрелка",
    desc: "Чистый wordmark + тонкая горизонталь под ним, переходящая в стрелку. Газетно-журнальный приём с минималистичным акцентом на движение.",
    Icon: IconUnderline,
    Logo: LogoUnderline,
  },
  {
    id: 7,
    name: "Концепт 7 — Скобки [LEAP]",
    desc: "Квадратные скобки вокруг названия — отсылка к журналистике, исходному коду, типографике. Подходит для медиа с deep-tech / business-аудиторией.",
    Icon: IconBrackets,
    Logo: LogoBrackets,
  },
  {
    id: 8,
    name: "Концепт 8 — LEAP. (точка)",
    desc: "Wordmark с яркой точкой в конце. Авторитетный, утвердительный тон («Это сказано — точка»). Стиль AP, NYT, Stratechery.",
    Icon: IconPeriod,
    Logo: LogoPeriod,
  },
  {
    id: 9,
    name: "Концепт 9 — Траектория прыжка",
    desc: "Дуга от точки старта к стрелке — буквальная визуализация «leap». Самая прямая метафора скачка вперёд. Дружелюбнее и теплее остальных.",
    Icon: IconArc,
    Logo: LogoArc,
  },
  {
    id: "4a",
    name: "Концепт 4a — Тройной шеврон под 45°",
    desc: "Три шеврона выстроены по диагонали вверх-вправо под углом 45° — направление и сила «leap» считываются с первой секунды. Композиция уникальная: тройная стрелка под углом не используется ни в одном известном медиа-бренде.",
    Icon: IconChevronTilt,
    Logo: LogoChevronTilt,
  },
  {
    id: "4b",
    name: "Концепт 4b — Восходящие шевроны",
    desc: "Три шеврона по диагонали вверх-вправо — каждый следующий выше предыдущего. Прыжок-прогресс, поступательное движение. Уникальная композиция, нет у других брендов.",
    Icon: IconChevronAscend,
    Logo: LogoChevronAscend,
  },
  {
    id: "4c",
    name: "Концепт 4c — Угловой шеврон (L-форма)",
    desc: "Двойной шеврон с прямыми углами вместо острых — каждый штрих превращается в букву «L», лежащую на боку. Бренд зашит в саму форму глифа.",
    Icon: IconChevronSquare,
    Logo: LogoChevronSquare,
  },
  {
    id: "4d",
    name: "Концепт 4d — Шеврон с траекторией прыжка",
    desc: "Пунктирная дуга прыжка приземляется в острый шеврон, направленный вперёд. Гибрид концепта 9 и 4: и метафора прыжка, и динамика движения.",
    Icon: IconChevronJump,
    Logo: LogoChevronJump,
  },
];
