...
//
// У reporter и editor наборы почти полные: им действительно нужно почти всё,
// и вырезано ровно то, чего роль не делает, — по одному разделу каждому.
// Экономия там небольшая (1,9k и 0,6k), но она бесплатна: механика та же.
const ROLES = {
  seo: [5, 7],
  translator: [4, 5],
  "fact-checker": [2, 3, 6, 8, 9, 10],
  // Без §9: чек-лист перед публикацией — работа editor'а, не корреспондента.
  reporter: [1, 2, 3, 4, 5, 6, 7, 8, 10],
  // Без §2: белый и чёрный списки источников применяют reporter и
  // fact-checker, до editor'а материал доходит с уже отобранными ссылками.
  editor: [1, 3, 4, 5, 6, 7, 8, 9, 10],
};
